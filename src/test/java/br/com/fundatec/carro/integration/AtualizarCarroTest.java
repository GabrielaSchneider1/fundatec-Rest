...
public class AtualizarCarroTest {
    ...
    public void deveAtualizarUmCarro() {
        ...
        Assert.assertEquals("IJL7145", carroOutputDto.getPlaca());
        Assert.assertEquals("2016-10-09", carroOutputDto.getDataFabricacao().toString());
        Assert.assertEquals("2017-10-05", carroOutputDto.getDataModelo().toString());
        ...
        Assert.assertEquals("IJL7145", carroAtualizado.getPlaca());
        Assert.assertEquals("2017-10-05", carroAtualizado.getDataModelo().toString());
